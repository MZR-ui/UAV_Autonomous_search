...
void pubTrackImage(const cv::Mat &imgTrack, const double t)
{
    ...
    sensor_msgs::ImagePtr imgTrackMsg(new sensor_msgs::Image());
    imgTrackMsg->header = header;
    imgTrackMsg->height = imgTrack.rows;
    imgTrackMsg->width = imgTrack.cols;
    imgTrackMsg->encoding = sensor_msgs::image_encodings::BGR8;
    imgTrackMsg->is_bigendian = 0;
    imgTrackMsg->step = imgTrack.step;
    imgTrackMsg->data.assign(imgTrack.data, imgTrack.data + imgTrack.total() * imgTrack.elemSize());
